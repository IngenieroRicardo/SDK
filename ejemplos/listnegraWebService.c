...
// Compilar en Windows: gcc -o listnegraWebService.exe listnegraWebService.c ./http.dll ./array.dll 
// Compilar en tipo UNIX: gcc -o listnegraWebService.bin listnegraWebService.c ./http.so ./array.so 
